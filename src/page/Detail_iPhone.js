    ...
    return (
        <div className="container-fluid detail">
            ...
            <div className="infor">
                ...
                <p className='Ram' ><span>Dung lượng:</span> {iPhone.infor}</p>
                <p className='text-white'>Màu: {iPhone.color}</p>
                <p className='text-white'>Hàng sẵn</p>
                ...
                <div className='Detail_buy'>
                    ...
                    <Link to="/Cart" className='addCart btn'><i className="fas fa-cart-plus"></i> </Link>
                </div>
