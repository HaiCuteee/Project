                            ...
                            <div className="infosp">
                                ...
                                <div className="promo">
                                    ...
                                    <div className="buttons_added">
                                        <button className="btn minus is-form" onClick={() => setCount(count - 1)}>-</button>
                                        <input className='input-qty' value={count} />
                                        <button className="btn plus is-form" onClick={() => setCount(count + 1)}>+</button>
                                    </div>
                            ...
                            <div className="infosp">
                                ...
                                <div className="promo">
                                    ...
                                    <div className="buttons_added">
                                        ...
                                        <button className="btn minus is-form" onClick={() => setCount1(count - 1)}>-</button>
                                        <input className='input-qty' value={count1} />
                                        <button className="btn plus is-form" onClick={() => setCount1(count + 1)}>+</button>
                                    </div>
